...
var Bling = (_temp2 = _class = function (_Component) {
    ...
    _createClass(Bling, [{
        ...
        value: function addMoatYieldReadyFunc(adSlot) {
            console.log('🚨🚨🚨 Executing setMoatPrebData() function...');
            console.log(`ad slot received:`, adSlot);
            ...
            if (window.moatPrebidApi && typeof window.moatPrebidApi.slotDataAvailable === 'function' && window.moatPrebidApi.slotDataAvailable()) {
                if(typeof adSlot != "undefined") {
                    console.log("MYI:  Slot level data added to one slot!");
                    return window.moatPrebidApi.setMoatTargetingForSlot(adSlot);
                } else {
                    // Sets available targeting data on all existing GPT slot objects.
                    console.log("MYI: slot level data added to all slots!");
                ...
                console.log(this.setMoatPrebidData);
                setTimeout(this.setMoatPrebidData, 100, adSlot);
                console.log("MYI: slot level data not available.");
                return false;
            }
        ...
        value: function configureSlot(adSlot) {
            ...
            setTimeout(function () {
                console.log('V V V V');
                console.log(window.top.moatPrebidApi);
                _this2.addMoatYieldReadyFunc(adSlot);
                // this.configureSlot(this._adSlot);
            }, 3000);
